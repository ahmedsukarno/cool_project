    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                // extract an object in the method passing in the name of the key here as a string
                properties = currentEarthquake.getJSONObject("properties");

                // extract a string in the method passing in the name of the key here as a string
                String magnitude = properties.getString("mag");
                String place = properties.getString("place");
                Long time = properties.getLong("time");

                // create a new earthquake object each time with this three variables and add it to the list of earthquakes
